...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Service::create([
            ...
            'img_for_banner' => 'images/repair_smartphone.png',
            'is_banner' => false,
            'type_service_id' => 1,
            'content_ru' => '
...
<h5 style="color: rgb(0, 0, 0);"><br></h5>
            ...
            'content_ua' => '<h1>Ремонт смартфонів в Харкові</h1>
                    <div class="service-description">
...
<h5 style="outline: 0px;"><span style="font-family: Verdana;"><br></span></h5><h5 style="outline: 0px;"><span style="font-family: Verdana;">Наш сервісний центр виконує ремонт телефонів ведучих виробників.</span></h5><div><h5 style="color: rgb(0, 0, 0);"><br></h5></div>
            ...
            'img_for_content' => 'https://service.electrodim.ua/images/repairsmrtph715x2000 copy.jpg'
        ]);
        ...
        Service::create([
            ...
            'img_for_banner' => 'images/repair_conditioner.jpg',
            'is_banner' => true,
            'type_service_id' => 1,
            'content_ru' => '<h1>Ремонт кондиционеров</h1>
                    <div class="service-description">
            ...
            'content_ua' => '<h1>Ремонт кондиціонерів</h1>
                    <div class="service-description">
            ...
            'img_for_content' => 'https://service.electrodim.ua/images/kondrepair copy.jpg'
        ]);
        ...
        Service::create([
            ...
            'img_for_banner' => 'images/montaj_TV.jpg',
            'is_banner' => true,
            'type_service_id' => 2,
